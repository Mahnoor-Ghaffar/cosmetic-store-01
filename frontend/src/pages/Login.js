...
const Login = () => {
    ...
    const handleSubmit = async(e) =>{
        ...
        if(dataApi.success){
            ...
            navigate('/')
            fetchUserDetails()
            dispatch(setUserDetails(dataApi.data)); //ch
            // fetchUserAddToCart()
        }
    ...
    <section id='login'>
        <div className='mx-auto container p-4'>
            ...
            <div className='bg-white p-5 w-full max-w-sm mx-auto'>
                    ...
                    <p className='my-5'>Don't have account ? <Link to={"/sign-up"} className=' text-pink-700 hover:text-pink-500 hover:underline'>Sign up</Link></p>
            </div>
